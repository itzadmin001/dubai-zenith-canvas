...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CjtNMWaj.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BsxpCnjZ.css";
...
var $$splitComponentImporter = () => import("./routes-O7mTcLs2.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Jhalak Technicals - Professional technical services and solutions for all your technical needs."
			},
			{
				property: "og:title",
				content: "Jhalak Technicals — Professional Services"
			},
			{
				property: "og:description",
		...
		scripts: [{
			...
			children: JSON.stringify({
				...
				description: "Professional technical services and solutions based in Dubai.",
